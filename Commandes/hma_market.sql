...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 08 fév. 2026 à 00:44
...
INSERT INTO `category` (`id`, `name`, `slug`, `description`, `image`, `is_active`, `created_at`, `updated_at`, `parent_id`, `user_id`) VALUES
(1, 'Produits alimentaires', 'produits-alimentaires', 'Idéale pour le déjeuner', '18900d7e-adbb-4530-ae71-f27216a5839b-53f369ca53cb1bd7d914c17103a9eb92-Copie-6977fe085273a.webp', 1, '2026-01-26 23:51:00', '2026-01-27 01:05:50', NULL, 4),
(2, 'Riz et pâtes', 'riz-et-pates', 'Idéales pour le déjeuner', 'riz-gras-697810270a75e.jpg', 1, '2026-01-27 01:08:47', '2026-01-27 01:08:55', 1, 4);
...
INSERT INTO `product` (`id`, `name`, `slug`, `description`, `barcode`, `sale_price`, `purchase_price`, `stock_quantity`, `min_quantity`, `image`, `is_active`, `created_at`, `updated_at`, `category_id`, `user_id`, `has_expiry_date`) VALUES
(1, 'Riz parfumé 5 Kg', 'riz-parfume-5-kg', 'Idéale pour les soirées', 'PROD-20260127-727660', '1500.00', '1200.00', 35, 10, 'Cliches-de-Saveurs-Ines-Millet-Prise-Direct-Noel-1-6979169991878.jpg', 1, '2026-01-27 19:11:59', '2026-01-29 01:20:01', 2, 4, 0);
...
INSERT INTO `supplier` (`id`, `name`, `contact_person`, `phone`, `email`, `adress`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'AMADOU Dine', 'Jean Koffi', '019741397', 'abiolaelamir@gmail.com', 'Cotonou/Avenue-Bénin', 1, '2021-01-01 00:00:00', '2021-01-01 00:00:00');
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `full_name`, `phone`, `is_active`, `created_at`, `updated_at`, `photo`) VALUES
(4, 'amir@gmail.com', '[\"ROLE_ADMIN\"]', '$2y$13$l3t7Cuz.B5aj2GqTUpCOAuo8DrT9GG9/9.uJWhYk35tTtFy8JhiQG', 'ABIOLA Amir', '0123456789', 1, '2026-01-25 19:31:26', '2026-01-26 13:57:44', NULL),
(5, 'mike@gmail.com', '[\"ROLE_MANAGER\"]', '$2y$13$5hfhaFJdeB51337ZRx6CIOBKiZb/iU145acOX1IQPpqWaonjkNK9G', 'AHOYO Mike', '0142301991', 1, '2026-01-25 21:12:04', '2026-01-26 13:56:15', 'photo-1522529599102-193c0d76b5b6-697767b2c8a8c.jpg'),
(6, 'haqq@gmail.com', '[\"ROLE_STOCK_MANAGER\"]', '$2y$13$GyRQxNWrn3fBVnkNuzwQqeGCuf6u3d7qmtjoJPVPek2Lu.FDzJVda', 'ABIOLA Haqq', '0191185545', 1, '2026-01-26 12:18:25', '2026-01-26 18:32:41', '39633047-ai-genere-portrait-de-barbu-noir-homme-sur-plan-contexte-photo-69775b8ee76e0.jpg'),
(7, 'mout@gmail.com', '[\"ROLE_CASHIER\"]', '$2y$13$fr8h.KzIbW1RPM0zF.4z5.uZMvAkRBj25CS76bvl9UZI/UyMThdZC', 'AMOUSSA', '0197824152', 1, '2026-01-26 17:28:32', '2026-01-26 17:28:19', 'chiro-6977a43ddb20f.png');
COMMIT;
