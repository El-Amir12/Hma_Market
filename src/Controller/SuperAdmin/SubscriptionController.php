...
{
    #[Route(name: 'app_super_admin_subscription_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_super_admin_subscription_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_super_admin_subscription_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_super_admin_subscription_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_super_admin_subscription_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Subscription $subscription, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('super_admin/subscription/edit.html.twig', [
            'subscription' => $subscription,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_super_admin_subscription_delete', methods: ['POST'])]
