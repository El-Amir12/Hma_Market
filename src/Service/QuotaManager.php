...
class QuotaManager
{
     ...
     */
    public function updateSubscriptionStatusForCompany(HmaService $hmaService): void
    {
        ...
        // Pour chaque rôle, trier par date de création (du plus récent au plus ancien)
        foreach ($usersByRole as $role => $roleUsers) {
            usort($roleUsers, function(User $a, User $b) {
                return $b->getCreatedAt() <=> $a->getCreatedAt();
            });

            // Activer les X premiers, désactiver les autres
