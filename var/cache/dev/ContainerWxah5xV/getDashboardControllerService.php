...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PfPx6aA'] ?? $container->load('get_ServiceLocator_PfPx6aAService'))->withContext('App\\Controller\\DashboardController', $container));
