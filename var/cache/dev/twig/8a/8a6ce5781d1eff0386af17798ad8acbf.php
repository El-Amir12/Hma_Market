...
class __TwigTemplate_e6063d27aacc93f3e96e252f75f93bf8 extends Template
{
...
(isset($context["activeBatches"]) || array_key_exists("activeBatches", $context) ? $context["activeBatches"] : (function () { throw new RuntimeError('Variable "activeBatches" does not exist.', 107, $this->source); })())) > 0)) {
    ...
    <div class=\"row\">
        ...
        yield "\" 
                        ...
                        <a href=\"";
        // line 457
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_product_stock_movements", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 457, $this->source); })()), "id", [], "any", false, false, false, 457)]), "html", null, true);
            ...
            <div class=\"card border-0 shadow-sm mb-4\">
                ...
                <div class=\"card-body\">
                    <div class=\"d-grid gap-2\">
                        ...
                        <!-- Lien vers les mouvements de stock -->
                        <a href=\"{{ path('app_admin_product_stock_movements', {'id': product.id}) }}\" class=\"btn btn-outline-primary\">
                            <i class=\"fas fa-exchange-alt me-2\"></i> Mouvements de stock
                        </a>
