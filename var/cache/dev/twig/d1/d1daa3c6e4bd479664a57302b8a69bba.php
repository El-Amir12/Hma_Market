...
class __TwigTemplate_5bcc99ad5d804b6944fd233be75acf06 extends Template
{
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.toggleFavorite = function(btn, productId) {
        ...
        .then(data => {
            if (data.success) {
                // ✅ Mettre à jour TOUS les boutons favoris du même produit
                ...
                // ✅ Déclencher un événement personnalisé pour synchroniser
        ...
        yield "', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    this.innerHTML = '<i class=\"fas fa-check me-1\"></i> Dans le panier';
    ...
    ";
        // line 1667
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 1667, $this->source); })()), "user", [], "any", false, false, false, 1667) && $this->extensions['App\Twig\RatingExtension']->isCustomer(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 1667, $this->source); })()), "user", [], "any", false, false, false, 1667)))) {
            // line 1668
