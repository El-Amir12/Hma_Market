...
class __TwigTemplate_27680cd52360b54639139739ea87b84c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/promotion/category/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/promotion/category/index.html.twig"));
    ...
    ";
        ...
        if (((isset($context["totalPages"]) || array_key_exists("totalPages", $context) ? $context["totalPages"] : (function () { throw new RuntimeError('Variable "totalPages" does not exist.', 208, $this->source); })()) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 213
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_category_index", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 213, $this->source); })()), "request", [], "any", false, false, false, 213), "query", [], "any", false, false, false, 213), "all", [], "any", false, false, false, 213), ["page" => $context["page"]])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return new Source("{# templates/admin/promotion/category/index.html.twig #}

{% extends 'base.html.twig' %}

{% block title %}Promotions par catégorie - HMA Market{% endblock %}
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        ...
        <div class=\"card-body\">
            <form method=\"get\" class=\"row g-3 align-items-end\">
                ...
                <div class=\"col-lg-2 col-md-12\">
                    <div class=\"d-flex gap-2\">
                        <a href=\"{{ path('app_admin_promotion_category_index') }}\" class=\"btn btn-outline-secondary flex-fill\">
                            <i class=\"fas fa-undo-alt me-1\"></i> Effacer
                        </a>
                        <button type=\"submit\" class=\"btn btn-primary flex-fill\">
                            <i class=\"fas fa-filter me-1\"></i> Filtrer
                                ...
                                <td>
                                 ...
                                 <td>
                                    ...
                                    {% if item.category.parent %}
                                        <small class=\"text-muted d-block\">(Sous-catégorie de {{ item.category.parent.name }})</small>
                                    {% endif %}
                                 </td>
                                <td class=\"small\">
                                 ...
                                 <td>
                                    <span class=\"badge bg-primary rounded-pill\">{{ item.category.products|length }}</span>
                                 </td>
                                 <td>
                                    <div class=\"btn-group btn-group-sm\">
                                        <a href=\"{{ path('app_admin_promotion_category_show', {id: item.id}) }}\" class=\"btn btn-outline-info\" title=\"Voir\">
                                            <i class=\"fas fa-eye\"></i>
                                        </a>
                                ...
                                <div class=\"modal-dialog modal-dialog-centered\">
                                    <div class=\"modal-content\">
                                        ...
                                        <div class=\"modal-body text-center py-4\">
                                            <i class=\"fas fa-trash-alt fa-4x text-danger mb-3\"></i>
                                            <h5>Supprimer cette association ?</h5>
                                            <p>La promotion <strong>{{ item.promotion.name }}</strong> ne sera plus appliquée à la catégorie <strong>{{ item.category.name }}</strong>.</p>
                                        </div>
                                        <div class=\"modal-footer border-0\">
                                            <button type=\"button\" class=\"btn btn-outline-secondary\" data-bs-dismiss=\"modal\">Annuler</button>
                                            <form method=\"post\" action=\"{{ path('app_admin_promotion_category_delete', {id: item.id}) }}\">
                                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete-category' ~ item.id) }}\">
                                                <button type=\"submit\" class=\"btn btn-danger\">Supprimer</button>
                                            </form>
                                        </div>
                                    </div>
            ...
            <ul class=\"pagination justify-content-center\">
                {% for page in 1..totalPages %}
                    <li class=\"page-item {{ page == currentPage ? 'active' }}\">
                        <a class=\"page-link\" href=\"{{ path('app_admin_promotion_category_index', app.request.query.all|merge({'page': page})) }}\">{{ page }}</a>
                    </li>
                {% endfor %}
            </ul>
        </nav>
...
{% endblock %}", "admin/promotion/category/index.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\promotion\\category\\index.html.twig");
    }
}
