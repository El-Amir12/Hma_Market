...
class __TwigTemplate_2919c996e4b5e319bec67613ff8c6417 extends Template
{
...
";
    ...
    {
        return array (  1008 => 838,  995 => 837,  972 => 824,  860 => 715,  839 => 697,  768 => 629,  762 => 626,  573 => 440,  567 => 437,  553 => 426,  550 => 425,  523 => 400,  519 => 399,  514 => 396,  501 => 395,  102 => 7,  89 => 6,  66 => 4,  43 => 2,);
    }
...
{% block body %}
        ...
        <div class=\"container\">
            ...
            <div class=\"collapse navbar-collapse\" id=\"navbarNav\">
                <ul class=\"navbar-nav ms-auto align-items-center\">
                    ...
                    {# ✅ MARKETPLACE AVEC BADGE NOUVEAU #}
                    <li class=\"nav-item\">
        ...
        <div class=\"container\">
            <div class=\"row align-items-center\">
                <div class=\"col-lg-6\">
                    ...
                    <div class=\"mt-4\">
                        <a href=\"{{ path('marketplace_home') }}\" class=\"btn btn-gradient btn-lg\">
                            <i class=\"bi bi-arrow-right me-2\"></i>Découvrir la Marketplace
                        </a>
                        <a href=\"{{ path('marketplace_pharmacy_search') }}\" class=\"btn btn-outline-gradient btn-lg ms-2\">
                            <i class=\"bi bi-search me-2\"></i>Rechercher
                        </a>
                    </div>
                </div>
    ...
    <footer class=\"bg-dark text-white py-4\">
        <div class=\"container\">
            <div class=\"row\">
                <div class=\"col-md-6\">
                    <p class=\"mb-0\">&copy; {{ \"now\"|date(\"Y\") }} HMA Service. Tous droits réservés.</p>
                </div>
                <div class=\"col-md-6 text-md-end\">
                    <a href=\"#\" class=\"text-white me-3\"><i class=\"bi bi-facebook\"></i></a>
                    <a href=\"#\" class=\"text-white me-3\"><i class=\"bi bi-twitter\"></i></a>
