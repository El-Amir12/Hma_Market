...
class __TwigTemplate_1f424c06aab2b24fafdac4a72249ce39 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/restaurant/promotion/recipe/index.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/restaurant/promotion/recipe/index.html.twig"));
    ...
    ";
        ...
        if (((isset($context["totalPages"]) || array_key_exists("totalPages", $context) ? $context["totalPages"] : (function () { throw new RuntimeError('Variable "totalPages" does not exist.', 204, $this->source); })()) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 209
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_promotion_recipe_index", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 209, $this->source); })()), "request", [], "any", false, false, false, 209), "query", [], "any", false, false, false, 209), "all", [], "any", false, false, false, 209), ["page" => $context["page"]])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return new Source("{# templates/admin/restaurant/promotion/recipe/index.html.twig #}

{% extends 'base.html.twig' %}

{% block title %}Promotions par plat - Restaurant{% endblock %}
        ...
        <div class=\"card-body\">
            <form method=\"get\" class=\"row g-3 align-items-end\">
                <div class=\"col-lg-4 col-md-6\">
                    ...
                    <div class=\"input-group\">
                        <span class=\"input-group-text bg-white border-end-0\"><i class=\"fas fa-search text-muted\"></i></span>
                        <input type=\"text\" name=\"search\" value=\"{{ search }}\" class=\"form-control border-start-0\" placeholder=\"Promotion ou plat...\">
                    </div>
                </div>
                <div class=\"col-lg-3 col-md-6\">
                    <label class=\"form-label fw-semibold\">Statut</label>
                ...
                <div class=\"col-lg-2 col-md-12\">
                    <div class=\"d-flex gap-2\">
                        <a href=\"{{ path('app_restaurant_promotion_recipe_index') }}\" class=\"btn btn-outline-secondary flex-fill\">
                            <i class=\"fas fa-undo-alt me-1\"></i> Effacer
                        </a>
                        <button type=\"submit\" class=\"btn btn-primary flex-fill\">
                            <i class=\"fas fa-filter me-1\"></i> Filtrer
                            ...
                            <tr>
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <br><small class=\"text-muted\">{{ item.recipe.category ? item.recipe.category.name : '-' }}</small>
                                 </td>
                                 <td>{{ item.recipe.category ? item.recipe.category.name : '-' }}</td>
                                <td class=\"small\">
                                 ...
                                 <td>
                                    <div class=\"btn-group btn-group-sm\">
                                        <a href=\"{{ path('app_restaurant_promotion_recipe_show', {id: item.id}) }}\" class=\"btn btn-outline-info\" title=\"Voir\">
                                            <i class=\"fas fa-eye\"></i>
                                        </a>
                                ...
                                <div class=\"modal-dialog modal-dialog-centered\">
                                    <div class=\"modal-content\">
                                        ...
                                        <div class=\"modal-body text-center py-4\">
                                            <i class=\"fas fa-trash-alt fa-4x text-danger mb-3\"></i>
                                            <h5>Supprimer cette association ?</h5>
                                            <p>La promotion <strong>{{ item.promotion.name }}</strong> ne sera plus appliquée au plat <strong>{{ item.recipe.name }}</strong>.</p>
                                        </div>
                                        <div class=\"modal-footer border-0\">
                                            <button type=\"button\" class=\"btn btn-outline-secondary\" data-bs-dismiss=\"modal\">Annuler</button>
                                            <form method=\"post\" action=\"{{ path('app_restaurant_promotion_recipe_delete', {id: item.id}) }}\">
                                                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete-recipe' ~ item.id) }}\">
                                                <button type=\"submit\" class=\"btn btn-danger\">Supprimer</button>
                                            </form>
                                        </div>
                                    </div>
            ...
            <ul class=\"pagination justify-content-center\">
                {% for page in 1..totalPages %}
                    <li class=\"page-item {{ page == currentPage ? 'active' }}\">
                        <a class=\"page-link\" href=\"{{ path('app_restaurant_promotion_recipe_index', app.request.query.all|merge({'page': page})) }}\">{{ page }}</a>
                    </li>
                {% endfor %}
            </ul>
        </nav>
...
{% endblock %}", "admin/restaurant/promotion/recipe/index.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\restaurant\\promotion\\recipe\\index.html.twig");
    }
}
