...
class __TwigTemplate_df7ef1af6f801f30bb75c016d9146753 extends Template
{
    ...
    <div class=\"d-flex flex-wrap justify-content-between align-items-center mb-4\">
        ...
        yield "\" class=\"btn btn-outline-secondary mb-2\">
            ...
            <p class=\"text-muted mb-0\">Gérez les associations promotion → produit</p>
        </div>
        <a href=\"";
        // line 19
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        ...
        yield "\" class=\"form-control border-start-0\" placeholder=\"Promotion ou produit...\">
                    </div>
                </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            yield "</small>
                                 ...
                                 <td>
                                    <strong>";
            // line 123
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 123), "name", [], "any", false, false, false, 123), "html", null, true);
            yield "</strong>
                                    <br><code>";
            // line 124
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 124), "barcode", [], "any", false, false, false, 124), "html", null, true);
            yield "</code>
                                 </td>
                                 <td>";
            // line 126
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 126), "category", [], "any", false, false, false, 126)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 126), "category", [], "any", false, false, false, 126), "name", [], "any", false, false, false, 126), "html", null, true)) : ("-"));
            yield "</td>
                                <td class=\"small\">
                                    ";
            // line 128
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "promotion", [], "any", false, false, false, 142), "typePromotion", [], "any", false, false, false, 142), "name", [], "any", false, false, false, 142) == "Pourcentage")) {
                ...
                // line 145
                yield "                                            ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "promotion", [], "any", false, false, false, 145), "value", [], "any", false, false, false, 145), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 145, $this->source); })()), "user", [], "any", false, false, false, 145), "hmaService", [], "any", false, false, false, 145)), "html", null, true);
                yield "
                                        ";
            }
            // line 147
            yield "                                    </span>
                                 ...
                                 <td>
                                    <div class=\"btn-group btn-group-sm\">
                                        <a href=\"";
            // line 151
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_product_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 151)]), "html", null, true);
            ...
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "product", [], "any", false, false, false, 174), "name", [], "any", false, false, false, 174), "html", null, true);
            yield "</strong>.</p>
                                        </div>
            ...
            // line 178
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_product_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 178)]), "html", null, true);
            yield "\">
                                                <input type=\"hidden\" name=\"_token\" value=\"";
            // line 179
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete-product" . CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 179))), "html", null, true);
            yield "\">
        ...
        if (!$context['_iterated']) {
            ...
            yield "                            <tr>
                                <td colspan=\"8\" class=\"text-center py-5 text-muted\">
                                    ...
                                    <p>Aucune association promotion-produit trouvée.</p>
                                    <a href=\"";
            // line 191
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_new");
    ...
    ";
        // line 204
        if (((isset($context["totalPages"]) || array_key_exists("totalPages", $context) ? $context["totalPages"] : (function () { throw new RuntimeError('Variable "totalPages" does not exist.', 204, $this->source); })()) > 1)) {
            // line 205
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                yield ((($context["page"] == (isset($context["currentPage"]) || array_key_exists("currentPage", $context) ? $context["currentPage"] : (function () { throw new RuntimeError('Variable "currentPage" does not exist.', 208, $this->source); })()))) ? ("active") : (""));
                yield "\">
                        <a class=\"page-link\" href=\"";
                // line 209
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_product_index", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 209, $this->source); })()), "request", [], "any", false, false, false, 209), "query", [], "any", false, false, false, 209), "all", [], "any", false, false, false, 209), ["page" => $context["page"]])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return array (  486 => 215,  481 => 212,  470 => 209,  465 => 208,  461 => 207,  457 => 205,  455 => 204,  446 => 197,  434 => 191,  428 => 187,  426 => 186,  414 => 179,  410 => 178,  401 => 174,  386 => 162,  375 => 154,  369 => 151,  363 => 147,  357 => 145,  351 => 143,  349 => 142,  341 => 137,  337 => 136,  333 => 134,  329 => 132,  323 => 130,  321 => 129,  317 => 128,  312 => 126,  307 => 124,  303 => 123,  297 => 120,  293 => 119,  289 => 117,  283 => 113,  275 => 111,  273 => 110,  269 => 108,  264 => 107,  236 => 82,  216 => 65,  210 => 61,  197 => 59,  193 => 58,  183 => 51,  179 => 50,  175 => 49,  166 => 43,  152 => 31,  143 => 29,  138 => 28,  129 => 26,  125 => 25,  116 => 19,  105 => 11,  100 => 8,  87 => 7,  64 => 5,  41 => 3,);
    }
        ...
        <div class=\"card-body\">
            <form method=\"get\" class=\"row g-3 align-items-end\">
                <div class=\"col-lg-4 col-md-6\">
                    ...
                    <div class=\"input-group\">
                        <span class=\"input-group-text bg-white border-end-0\"><i class=\"fas fa-search text-muted\"></i></span>
                        <input type=\"text\" name=\"search\" value=\"{{ search }}\" class=\"form-control border-start-0\" placeholder=\"Promotion ou produit...\">
                    </div>
                </div>
                <div class=\"col-lg-3 col-md-6\">
                    <label class=\"form-label fw-semibold\">Statut</label>
                ...
                <div class=\"col-lg-2 col-md-12\">
                    <div class=\"d-flex gap-2\">
                        <a href=\"{{ path('app_admin_promotion_product_index') }}\" class=\"btn btn-outline-secondary flex-fill\">
                            <i class=\"fas fa-undo-alt me-1\"></i> Effacer
                        </a>
                        <button type=\"submit\" class=\"btn btn-primary flex-fill\">
                            <i class=\"fas fa-filter me-1\"></i> Filtrer
                            ...
                            <tr>
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <br><code>{{ item.product.barcode }}</code>
                                 </td>
                                ...
                                <td class=\"small\">
                                 ...
                                 <td>
                                    <div class=\"btn-group btn-group-sm\">
                                        <a href=\"{{ path('app_admin_promotion_product_show', {id: item.id}) }}\" class=\"btn btn-outline-info\" title=\"Voir\">
                                            <i class=\"fas fa-eye\"></i>
                                        </a>
                                ...
                                <div class=\"modal-dialog modal-dialog-centered\">
                                    <div class=\"modal-content\">
                                        ...
                                        <div class=\"modal-body text-center py-4\">
                                            <i class=\"fas fa-trash-alt fa-4x text-danger mb-3\"></i>
                                            <h5>Supprimer cette association ?</h5>
                                            <p>La promotion <strong>{{ item.promotion.name }}</strong> ne sera plus appliquée au produit <strong>{{ item.product.name }}</strong>.</p>
                                        </div>
                                        <div class=\"modal-footer border-0\">
                                            <button type=\"button\" class=\"btn btn-outline-secondary\" data-bs-dismiss=\"modal\">Annuler</button>
            ...
            <ul class=\"pagination justify-content-center\">
                {% for page in 1..totalPages %}
                    <li class=\"page-item {{ page == currentPage ? 'active' }}\">
                        <a class=\"page-link\" href=\"{{ path('app_admin_promotion_product_index', app.request.query.all|merge({'page': page})) }}\">{{ page }}</a>
                    </li>
                {% endfor %}
            </ul>
        </nav>
