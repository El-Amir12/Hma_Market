...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Twig\\GlobalVariables' => 'getGlobalVariablesService',
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Marketplace\\ForgotPasswordController' => 'getForgotPasswordControllerService',
            ...
            'App\\Controller\\SuperAdmin\\AnalysisRequestController' => 'getAnalysisRequestControllerService',
            'App\\Controller\\SuperAdmin\\AnalysisStatisticsController' => 'getAnalysisStatisticsControllerService',
            ...
            'App\\Service\\OrderService' => 'getOrderServiceService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'ActivityListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'CustomerLoginListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'CustomerTargetPathListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'MustChangePasswordListener.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventSubscriber'.\DIRECTORY_SEPARATOR.'UserDisabledSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'MenuBuilder.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'GlobalVariables.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'ArrayExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'ColorExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'CompanyExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'CountryExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'FcfaExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'MarketplaceExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'MarketplaceDataService.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'MenuExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'RatingExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'RoleExtension.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'SubscriptionExtension.php';
    ...
    /**
     * Gets the public 'App\Twig\GlobalVariables' shared autowired service.
     *
     * @return \App\Twig\GlobalVariables
     */
    protected static function getGlobalVariablesService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->services['App\\Twig\\GlobalVariables'])) {
            return $container->services['App\\Twig\\GlobalVariables'];
        }

        $instance = new \App\Twig\GlobalVariables($a, ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['App\\Repository\\FavoriteRepository'] ?? self::getFavoriteRepositoryService($container)), ($container->services['App\\Repository\\CartRepository'] ?? self::getCartRepositoryService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));

        if (isset($container->services['App\\Twig\\GlobalVariables'])) {
            return $container->services['App\\Twig\\GlobalVariables'];
        }

        return $container->services['App\\Twig\\GlobalVariables'] = $instance;
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vEaw+TBFSy', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6-OwuhcCRn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A+VvatU7ZV', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\CustomerTargetPathListener')] fn () => ($container->privates['App\\EventListener\\CustomerTargetPathListener'] ?? self::getCustomerTargetPathListenerService($container)), 'onKernelRequest'], 0);
    ...
    /**
     * Gets the private 'App\EventListener\CustomerTargetPathListener' shared autowired service.
     *
     * @return \App\EventListener\CustomerTargetPathListener
     */
    protected static function getCustomerTargetPathListenerService($container)
    {
        return $container->privates['App\\EventListener\\CustomerTargetPathListener'] = new \App\EventListener\CustomerTargetPathListener(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
     ...
     */
    protected static function getFavoriteRepositoryService($container)
    {
     ...
     */
    protected static function getOrderItemRepositoryService($container)
    {
     ...
     */
    protected static function getSubscriptionRepositoryService($container)
    {
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A0DiEmN+0P', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('O4wuFPO+W7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cMuwemccyi', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MYG9BEi6iS', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EYSw9Axen9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xNmQvgvKR1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        $instance = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'] ?? $container->load('getPaymentVoterService'));
            yield 4 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\SubscriptionVoter'] ?? $container->load('getSubscriptionVoterService'));
    ...
    protected static function getDebug_Security_EventDispatcher_CustomerService($container)
    {
        ...
        if (isset($container->privates['debug.security.event_dispatcher.customer'])) {
            return $container->privates['debug.security.event_dispatcher.customer'];
        }

        $container->privates['debug.security.event_dispatcher.customer'] = $instance;
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\CartRepository' => ['services', 'App\\Repository\\CartRepository', 'getCartRepositoryService', false],
            ...
            'App\\Repository\\CustomerRepository' => ['services', 'App\\Repository\\CustomerRepository', 'getCustomerRepositoryService', false],
            ...
            'App\\Repository\\FavoriteRepository' => ['privates', 'App\\Repository\\FavoriteRepository', 'getFavoriteRepositoryService', false],
    ...
    protected static function getTwigService($container)
    {
        ...
        $i = ($container->privates['App\\Repository\\FavoriteRepository'] ?? self::getFavoriteRepositoryService($container));
        $j = ($container->services['App\\Repository\\CartRepository'] ?? self::getCartRepositoryService($container));
        $k = ($container->privates['App\\Repository\\OrderItemRepository'] ?? self::getOrderItemRepositoryService($container));
        $l = ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container));
        $m = new \Symfony\Component\VarDumper\Dumper\HtmlDumper(NULL, 'UTF-8', 1);
        $m->setDisplayOptions(['maxStringLength' => 4096, 'fileLinkFormat' => $d]);
        ...
        $n->setLocaleSwitcher(($container->privates['translation.locale_switcher'] ?? self::getTranslation_LocaleSwitcherService($container)));
        $n->setEnabledLocales([]);
        $o = ($container->services['App\\Twig\\GlobalVariables'] ?? self::getGlobalVariablesService($container));
        ...
        $instance->addExtension(new \App\Twig\AppExtension($h, $g, $i, $j, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), $k));
        $instance->addExtension(new \App\Twig\ArrayExtension());
        $instance->addExtension(new \App\Twig\ColorExtension($l));
        $instance->addExtension(new \App\Twig\CompanyExtension($l));
        $instance->addExtension(new \App\Twig\CountryExtension());
        $instance->addExtension(new \App\Twig\FcfaExtension());
        $instance->addExtension(new \App\Twig\MarketplaceExtension(($container->privates['App\\Repository\\CategoryRepository'] ?? self::getCategoryRepositoryService($container)), ($container->services['App\\Repository\\CustomerRepository'] ?? self::getCustomerRepositoryService($container)), $l, $h, new \App\Service\MarketplaceDataService($h, $i, $j)));
        $instance->addExtension(new \App\Twig\MenuExtension(($container->services['App\\Service\\MenuBuilder'] ?? self::getMenuBuilderService($container))));
        $instance->addExtension(new \App\Twig\RatingExtension($k));
        $instance->addExtension(new \App\Twig\RoleExtension());
        $instance->addExtension(new \App\Twig\SubscriptionExtension(($container->privates['App\\Repository\\SubscriptionRepository'] ?? self::getSubscriptionRepositoryService($container))));
        ...
        $instance->addGlobal('favorites_count', $o);
        $instance->addGlobal('cart_count', $o);
        $instance->registerUndefinedFilterCallback([$p, 'suggestFilter']);
        $instance->registerUndefinedFunctionCallback([$p, 'suggestFunction']);
        $instance->registerUndefinedTokenParserCallback([$p, 'suggestTag']);
