 ...
 */
class getPaymentVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.debug.security.voter.App\Security\Voter\PaymentVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'PaymentVoter.php';

        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'];
        }

        $instance = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\Voter\PaymentVoter(), $a);

        if (isset($container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'];
        }

        return $container->privates['.debug.security.voter.App\\Security\\Voter\\PaymentVoter'] = $instance;
    }
}
