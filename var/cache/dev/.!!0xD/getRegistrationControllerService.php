...
class getRegistrationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.OoEy.Ic'] ?? $container->load('get_ServiceLocator_OoEy_IcService'))->withContext('App\\Controller\\RegistrationController', $container));
