...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.vdabmcB'] ?? self::get_ServiceLocator_VdabmcBService($container)), ($container->privates['.service_locator.YgzSunF'] ?? $container->load('get_ServiceLocator_YgzSunFService')), ['customer' => [($container->privates['App\\Security\\CustomerAuthenticator'] ?? $container->load('getCustomerAuthenticatorService')), ($container->privates['security.authenticator.remember_me.customer'] ?? $container->load('getSecurity_Authenticator_RememberMe_CustomerService'))], 'main' => [($container->privates['App\\Security\\LoginFormAuthentificatorAuthenticator'] ?? $container->load('getLoginFormAuthentificatorAuthenticatorService')), ($container->privates['security.authenticator.remember_me.main'] ?? $container->load('getSecurity_Authenticator_RememberMe_MainService'))]], false);
