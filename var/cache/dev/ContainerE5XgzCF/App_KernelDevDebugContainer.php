...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getTwigService($container)
    {
        ...
        $i = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));
        ...
        $instance->addExtension(new \App\Twig\ColorExtension($h));
        $instance->addExtension(new \App\Twig\CompanyExtension($h));
        $instance->addExtension(new \App\Twig\FcfaExtension());
        $instance->addExtension(new \App\Twig\MarketplaceExtension(($container->privates['App\\Repository\\CategoryRepository'] ?? self::getCategoryRepositoryService($container)), ($container->services['App\\Repository\\CustomerRepository'] ?? self::getCustomerRepositoryService($container)), $h, $i, new \App\Service\MarketplaceDataService($i, ($container->privates['App\\Repository\\FavoriteRepository'] ?? self::getFavoriteRepositoryService($container)), ($container->services['App\\Repository\\CartRepository'] ?? self::getCartRepositoryService($container)))));
