...
class getCustomerAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\CustomerAuthenticator'])) {
            return $container->privates['App\\Security\\CustomerAuthenticator'];
        }

        $instance = new \App\Security\CustomerAuthenticator(($container->services['router'] ?? self::getRouterService($container)), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));

        if (isset($container->privates['App\\Security\\CustomerAuthenticator'])) {
            return $container->privates['App\\Security\\CustomerAuthenticator'];
        }

        return $container->privates['App\\Security\\CustomerAuthenticator'] = $instance;
    }
}
