...
class getDashboardControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.WgYxIqT'] ?? $container->load('get_ServiceLocator_WgYxIqTService'))->withContext('App\\Controller\\DashboardController', $container));
