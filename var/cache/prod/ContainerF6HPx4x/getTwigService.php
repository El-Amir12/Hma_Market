...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \App\Twig\CompanyExtension($f));
        $instance->addExtension(new \App\Twig\FcfaExtension());
        $instance->addExtension(new \App\Twig\MarketplaceExtension(($container->privates['App\\Repository\\CategoryRepository'] ?? $container->load('getCategoryRepositoryService')), ($container->services['App\\Repository\\CustomerRepository'] ?? $container->load('getCustomerRepositoryService')), $f, $g, new \App\Service\MarketplaceDataService($g, ($container->privates['App\\Repository\\FavoriteRepository'] ?? $container->load('getFavoriteRepositoryService')), ($container->services['App\\Repository\\CartRepository'] ?? $container->load('getCartRepositoryService')))));
        $instance->addExtension(new \App\Twig\MenuExtension(($container->services['App\\Service\\MenuBuilder'] ?? $container->load('getMenuBuilderService'))));
        $instance->addExtension(new \App\Twig\RoleExtension());
        $instance->addExtension(new \App\Twig\SubscriptionExtension(($container->privates['App\\Repository\\SubscriptionRepository'] ?? $container->load('getSubscriptionRepositoryService'))));
