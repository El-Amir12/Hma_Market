...
class __TwigTemplate_1521d6ee6bfa4822d6f6d3af9e57ff51 extends Template
{
...
<body>
    <div class=\"container\">
        ...
        <div class=\"content\">
            <p>Bonjour <strong>";
        // line 124
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 124), "html", null, true);
        yield "</strong>,</p>
        ...
        // line 130
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 130), "html", null, true);
        yield "</p>
                <p><strong>Type :</strong> ";
        // line 131
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyType", [], "any", false, false, false, 131), "html", null, true);
        yield "</p>
                <p><strong>Email :</strong> ";
        // line 132
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 132), "html", null, true);
        yield "</p>
                <p><strong>Téléphone :</strong> ";
        // line 133
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "phone", [], "any", false, false, false, 133), "html", null, true);
        yield "</p>
                <p><strong>Période d'essai :</strong> Jusqu'au ";
        // line 134
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "trialEndsAt", [], "any", false, false, false, 134), "d/m/Y"), "html", null, true);
        yield "</p>
            </div>
        ...
        // line 141
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 141), "html", null, true);
        yield "</p>
    ...
    {
        return array (  281 => 212,  219 => 153,  206 => 143,  201 => 141,  191 => 134,  187 => 133,  183 => 132,  179 => 131,  175 => 130,  166 => 124,  42 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "emails/welcome.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\emails\\welcome.html.twig");
    }
}
