...
class __TwigTemplate_a80222f34b3cb01798b988436ea23367 extends Template
{
    ...
    ";
        ...
        if ((($context["totalPages"] ?? null) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 209
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_product_index", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 209), "query", [], "any", false, false, false, 209), "all", [], "any", false, false, false, 209), ["page" => $context["page"]])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return new Source("", "admin/promotion/product/index.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\promotion\\product\\index.html.twig");
    }
}
