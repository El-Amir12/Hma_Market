...
class __TwigTemplate_8d4056205fced430531d9a2fbf642bba extends Template
{
...
";
    ...
    <div class=\"card border-0 shadow-sm mb-4\">
        ...
        // line 110
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 110), "html", null, true);
        yield "</div>
                            </div>
                        </div>
                        <div class=\"col-md-6\">
                            <div class=\"mb-2\">
                                ...
                                <div class=\"fw-bold\">";
        // line 116
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "subscriptionNumber", [], "any", false, false, false, 116), "html", null, true);
        yield "</div>
                            </div>
                        </div>
                        <div class=\"col-md-6\">
                            <div class=\"mb-2\">
                                ...
                                <div>";
        // line 122
        yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "type", [], "any", false, false, false, 122) == "restaurant")) ? ("🍽️ Restaurant") : ("🛒 Commerce"));
        yield "</div>
                            </div>
                        </div>
                        <div class=\"col-md-6\">
                            <div class=\"mb-2\">
                                ...
                                <div>";
        // line 128
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 128), "html", null, true);
        yield "</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class=\"card border-0 shadow-sm\">
        ...
        // line 147
        yield "            ";
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form"] ?? null), 'form_start', ["attr" => ["id" => "analysisForm"]]);
        yield "
            ";
        // line 148
        ...
        yield "
            ...
            ";
        // line 151
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "type", [], "any", false, false, false, 151), 'widget', ["attr" => ["style" => "display: none;", "id" => "typeInput"]]);
        yield "
        ...
        yield "                </div>
            ...
            <div class=\"row g-3 mb-4\">
                <div class=\"col-md-6\">
                    ";
        // line 191
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 191), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📅 Date de début"]);
        yield "
                    ";
        // line 192
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 192), 'widget', ["attr" => ["class" => "form-control", "id" => "periodStart"]]);
        yield "
                    <small class=\"text-muted\">Maximum 365 jours (1 an)</small>
                    ";
        // line 194
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 194), 'errors');
        yield "
                </div>
                <div class=\"col-md-6\">
                    ";
        // line 197
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 197), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📅 Date de fin"]);
        yield "
                    ";
        // line 198
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 198), 'widget', ["attr" => ["class" => "form-control", "id" => "periodEnd"]]);
        yield "
                    ";
        // line 199
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 199), 'errors');
        yield "
                </div>
            </div>
            ...
            <div class=\"mb-4\">
                ";
        // line 208
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 208), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📝 Notes / Instructions"]);
        yield "
                ";
        // line 209
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 209), 'widget', ["attr" => ["class" => "form-control", "rows" => 4, "placeholder" => "Informations complémentaires pour l'analyse..."]]);
        yield "
                <small class=\"text-muted\">Ces notes seront transmises à l'équipe d'analyse</small>
                ";
        // line 211
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 211), 'errors');
        yield "
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitBtn.addEventListener('click', function(e) {
        ...
        // line 441
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 441), "html", null, true);
        yield "
                </div>
                <div class=\"mb-2\">
...
";
    ...
    {
        return array (  637 => 441,  483 => 290,  476 => 289,  435 => 252,  424 => 244,  388 => 211,  383 => 209,  379 => 208,  367 => 199,  363 => 198,  359 => 197,  353 => 194,  348 => 192,  344 => 191,  333 => 182,  323 => 178,  316 => 176,  312 => 175,  306 => 173,  302 => 171,  298 => 169,  296 => 168,  293 => 167,  291 => 166,  288 => 165,  286 => 164,  283 => 163,  281 => 162,  277 => 161,  273 => 160,  269 => 159,  265 => 157,  261 => 156,  253 => 151,  247 => 148,  242 => 147,  221 => 128,  212 => 122,  203 => 116,  194 => 110,  165 => 84,  149 => 71,  141 => 65,  134 => 64,  73 => 7,  66 => 6,  54 => 4,  43 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "super_admin/analysis/new.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\super_admin\\analysis\\new.html.twig");
    }
}
