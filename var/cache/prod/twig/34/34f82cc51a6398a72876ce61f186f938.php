...
class __TwigTemplate_0aac44ccdc939b0a88df2bc5d5c996c8 extends Template
{
    ...
    <div class=\"d-flex flex-wrap justify-content-between align-items-center mb-4\">
        ...
        yield "\" class=\"text-decoration-none\">
                    ...
                    <li class=\"breadcrumb-item\">
                        <a href=\"";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_recipe_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 19)]), "html", null, true);
        yield "\" class=\"text-decoration-none\">
                            ";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $this->extensions['Twig\Extra\String\StringExtension']->createUnicodeString(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 20)), "truncate", [30], "method", false, false, false, 20), "html", null, true);
        yield "
                        </a>
                    </li>
            ...
            <p class=\"text-muted mb-0\">
                Plat : <strong>";
        // line 32
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 32), "html", null, true);
        yield "</strong> | 
                Prix : <strong>";
        // line 33
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "sellingPrice", [], "any", false, false, false, 33), CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "hmaService", [], "any", false, false, false, 33)), "html", null, true);
        yield "</strong>
            </p>
        </div>
        <div class=\"d-flex gap-2\">
            <a href=\"";
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_recipe_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 37)]), "html", null, true);
        ...
        yield "?recipe_id=";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 40), "html", null, true);
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        <div class=\"card-body\">
            <div class=\"row align-items-center\">
                <div class=\"col-md-2 text-center\">
                    ";
        // line 59
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "image", [], "any", false, false, false, 59)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 60
            yield "                        <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images_plats/" . CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "image", [], "any", false, false, false, 60))), "html", null, true);
            yield "\" 
                             alt=\"";
            // line 61
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 61), "html", null, true);
            yield "\" 
        ...
        // line 74
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 74), "html", null, true);
        yield "</p>
                        </div>
                        <div class=\"col-md-4\">
        ...
        // line 78
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "sellingPrice", [], "any", false, false, false, 78), CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "hmaService", [], "any", false, false, false, 78)), "html", null, true);
        yield "</p>
                        </div>
                        <div class=\"col-md-4\">
                            ...
                            <p class=\"mb-0\">";
        // line 82
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "category", [], "any", false, false, false, 82)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "category", [], "any", false, false, false, 82), "name", [], "any", false, false, false, 82), "html", null, true)) : ("Non catégorisé"));
        yield "</p>
                        </div>
                    </div>
                </div>
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        ...
        yield ">Terminées</option>
                ...
                <div class=\"col-lg-2 d-flex gap-2 align-items-end\">
                    <a href=\"";
        // line 199
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_recipe_promotions", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 199)]), "html", null, true);
    ...
    <div class=\"row g-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["promotion"]) {
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "typePromotion", [], "any", false, false, false, 238), "name", [], "any", false, false, false, 238) == "Pourcentage")) {
                ...
                // line 241
                yield "                                    ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "value", [], "any", false, false, false, 241), CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "hmaService", [], "any", false, false, false, 241)), "html", null, true);
                yield "
                                ";
            }
            // line 243
...
$context["promotion"], "endDate", [], "any", false, false, false, 266) && (CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "endDate", [], "any", false, false, false, 266) < $this->extensions['Twig\Extension\CoreExtension']->convertDate()))) {
        ...
        if (!$context['_iterated']) {
            ...
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_promotion_new");
            yield "?recipe_id=";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 336), "html", null, true);
    ...
    ";
        ...
        if ((($context["totalPages"] ?? null) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 351
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_recipe_promotions", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 351), "query", [], "any", false, false, false, 351), "all", [], "any", false, false, false, 351), ["page" => $context["page"], "id" => CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "id", [], "any", false, false, false, 351)])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return array (  669 => 357,  664 => 354,  653 => 351,  648 => 350,  644 => 349,  640 => 347,  638 => 346,  633 => 343,  618 => 336,  610 => 330,  605 => 329,  594 => 321,  590 => 320,  581 => 314,  563 => 300,  561 => 299,  554 => 294,  546 => 290,  544 => 289,  538 => 286,  532 => 283,  523 => 277,  515 => 271,  509 => 267,  507 => 266,  502 => 263,  500 => 262,  495 => 259,  493 => 258,  487 => 254,  483 => 252,  477 => 250,  475 => 249,  471 => 248,  464 => 243,  458 => 241,  452 => 239,  450 => 238,  443 => 233,  439 => 232,  435 => 231,  428 => 227,  424 => 226,  420 => 225,  415 => 222,  409 => 218,  401 => 216,  399 => 215,  395 => 213,  390 => 212,  374 => 199,  367 => 195,  363 => 194,  359 => 193,  355 => 192,  346 => 186,  342 => 185,  338 => 184,  329 => 178,  305 => 157,  291 => 146,  277 => 135,  263 => 124,  249 => 113,  235 => 102,  212 => 82,  205 => 78,  198 => 74,  191 => 69,  185 => 65,  178 => 61,  173 => 60,  171 => 59,  163 => 53,  154 => 51,  149 => 50,  140 => 48,  136 => 47,  124 => 40,  118 => 37,  111 => 33,  107 => 32,  92 => 20,  88 => 19,  80 => 14,  71 => 7,  64 => 6,  52 => 4,  41 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "admin/restaurant/promotion/recipe_promotions.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\restaurant\\promotion\\recipe_promotions.html.twig");
    }
}
