...
class __TwigTemplate_150d92b46f7b13ec7ccafd9b21bf1100 extends Template
{
    ...
    <div class=\"d-flex flex-wrap justify-content-between align-items-center mb-4\">
        ...
        yield "\" class=\"text-decoration-none\">
                    ...
                    <li class=\"breadcrumb-item\">
                        <a href=\"";
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_product_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 19)]), "html", null, true);
        yield "\" class=\"text-decoration-none\">
                            ";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $this->extensions['Twig\Extra\String\StringExtension']->createUnicodeString(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 20)), "truncate", [30], "method", false, false, false, 20), "html", null, true);
        yield "
                        </a>
                    </li>
        ...
        yield "</strong> | 
                Code-barres : <strong>";
        // line 33
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "barcode", [], "any", false, false, false, 33), "html", null, true);
        yield "</strong>
            </p>
        </div>
        <div class=\"d-flex gap-2\">
            <a href=\"";
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_product_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 37)]), "html", null, true);
        ...
        yield "?product_id=";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 40), "html", null, true);
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        <div class=\"card-body\">
            <div class=\"row align-items-center\">
                <div class=\"col-md-2 text-center\">
                    ";
        // line 59
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 59) && (CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 59) != "default-product.png"))) {
            // line 60
            yield "                        <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/products/" . CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "image", [], "any", false, false, false, 60))), "html", null, true);
            yield "\" 
                             alt=\"";
            // line 61
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 61), "html", null, true);
            yield "\" 
        ...
        // line 74
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "barcode", [], "any", false, false, false, 74), "html", null, true);
        yield "</p>
                        </div>
                        <div class=\"col-md-4\">
        ...
        // line 78
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "salePrice", [], "any", false, false, false, 78), CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "hmaService", [], "any", false, false, false, 78)), "html", null, true);
        yield "</p>
                        </div>
                        <div class=\"col-md-4\">
                            ...
                            <p class=\"mb-0\">";
        // line 82
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "category", [], "any", false, false, false, 82)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "category", [], "any", false, false, false, 82), "name", [], "any", false, false, false, 82), "html", null, true)) : ("Non catégorisé"));
        yield "</p>
                        </div>
                    </div>
                </div>
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        ...
        // line 124
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["promotions"] ?? null), function ($__p__) use ($context, $macros) { $context["p"] = $__p__; return  !CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "isActive", [], "any", false, false, false, 124); })), "html", null, true);
        yield "</h3>
                            </div>
        ...
        // line 146
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["promotions"] ?? null), function ($__p__) use ($context, $macros) { $context["p"] = $__p__; return CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "isUpcoming", [], "any", false, false, false, 146); })), "html", null, true);
        yield "</h3>
                            </div>
        ...
        // line 157
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), Twig\Extension\CoreExtension::filter($this->env, ($context["promotions"] ?? null), function ($__p__) use ($context, $macros) { $context["p"] = $__p__; return CoreExtension::getAttribute($this->env, $this->source, ($context["p"] ?? null), "isEnded", [], "any", false, false, false, 157); })), "html", null, true);
        yield "</h3>
                            </div>
    ...
    <div class=\"card shadow-sm border-0 mb-4\">
        ...
        yield ">Terminées</option>
                ...
                <div class=\"col-lg-2 d-flex gap-2 align-items-end\">
                    <a href=\"";
        // line 199
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_product_promotions", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 199)]), "html", null, true);
    ...
    <div class=\"row g-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["promotion"]) {
            ...
            if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "typePromotion", [], "any", false, false, false, 238), "name", [], "any", false, false, false, 238) == "Pourcentage")) {
                ...
                // line 241
                yield "                                    ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "value", [], "any", false, false, false, 241), CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "hmaService", [], "any", false, false, false, 241)), "html", null, true);
                yield "
                                ";
            }
            // line 243
...
$context["promotion"], "endDate", [], "any", false, false, false, 266) && (CoreExtension::getAttribute($this->env, $this->source, $context["promotion"], "endDate", [], "any", false, false, false, 266) < $this->extensions['Twig\Extension\CoreExtension']->convertDate()))) {
        ...
        if (!$context['_iterated']) {
            ...
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_promotion_new");
            yield "?product_id=";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 328), "html", null, true);
    ...
    ";
        ...
        if ((($context["totalPages"] ?? null) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 343
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_product_promotions", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 343), "query", [], "any", false, false, false, 343), "all", [], "any", false, false, false, 343), ["page" => $context["page"], "id" => CoreExtension::getAttribute($this->env, $this->source, ($context["product"] ?? null), "id", [], "any", false, false, false, 343)])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return array (  658 => 349,  653 => 346,  642 => 343,  637 => 342,  633 => 341,  629 => 339,  627 => 338,  622 => 335,  607 => 328,  599 => 322,  594 => 321,  583 => 313,  579 => 312,  570 => 306,  552 => 292,  550 => 291,  543 => 286,  535 => 282,  533 => 281,  527 => 278,  521 => 275,  515 => 271,  509 => 267,  507 => 266,  502 => 263,  500 => 262,  495 => 259,  493 => 258,  487 => 254,  483 => 252,  477 => 250,  475 => 249,  471 => 248,  464 => 243,  458 => 241,  452 => 239,  450 => 238,  443 => 233,  439 => 232,  435 => 231,  428 => 227,  424 => 226,  420 => 225,  415 => 222,  409 => 218,  401 => 216,  399 => 215,  395 => 213,  390 => 212,  374 => 199,  367 => 195,  363 => 194,  359 => 193,  355 => 192,  346 => 186,  342 => 185,  338 => 184,  329 => 178,  305 => 157,  291 => 146,  277 => 135,  263 => 124,  249 => 113,  235 => 102,  212 => 82,  205 => 78,  198 => 74,  191 => 69,  185 => 65,  178 => 61,  173 => 60,  171 => 59,  163 => 53,  154 => 51,  149 => 50,  140 => 48,  136 => 47,  124 => 40,  118 => 37,  111 => 33,  107 => 32,  92 => 20,  88 => 19,  80 => 14,  71 => 7,  64 => 6,  52 => 4,  41 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "admin/promotion/product_promotions.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\promotion\\product_promotions.html.twig");
    }
}
