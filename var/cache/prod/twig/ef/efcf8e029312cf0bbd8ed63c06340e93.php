...
class __TwigTemplate_99e2436484d0116eebeb612d6e41e115 extends Template
{
                    ...
                    <div class=\"d-flex justify-content-between align-items-center flex-wrap gap-2\">
                        <div>
                            ...
                            <div class=\"credit-number\">
                                N° ";
        // line 260
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "creditNoteNumber", [], "any", false, false, false, 260), "html", null, true);
        yield "
                            </div>
                        </div>
                        <div>
                            <span class=\"badge-issue 
                                ";
        // line 265
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 265) == "quality")) {
            yield "badge-quality
                                ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 266
($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 266) == "damaged")) {
            yield "badge-damaged
                                ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 267
($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 267) == "quantity_missing")) {
        ...
        yield "\">
                                <i class=\"fas 
                                    ";
        // line 270
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 270) == "quality")) {
            yield "fa-flask
                                    ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 271
($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 271) == "damaged")) {
            yield "fa-box
                                    ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 272
($context["creditNote"] ?? null), "issueType", [], "any", false, false, false, 272) == "quantity_missing")) {
            yield "fa-calculator
                                    ";
        } else {
            // line 273
        ...
        yield " me-1\"></i>
                                ";
        // line 274
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "issueTypeLabel", [], "any", false, false, false, 274), "html", null, true);
        yield "
                            </span>
                        </div>
                    </div>
        ...
        // line 285
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, false, false, 285), "product", [], "any", false, false, false, 285), "name", [], "any", false, false, false, 285), "html", null, true);
        yield "</span>
                        </div>
                        <div class=\"info-row\">
                            ...
                            <span class=\"info-value\">";
        // line 289
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, false, false, 289), "batchNumber", [], "any", false, false, false, 289), "html", null, true);
        yield "</span>
                        </div>
                        <div class=\"info-row\">
                            ...
                            <span class=\"info-value\">";
        // line 293
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "affectedQuantity", [], "any", true, true, false, 293)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "affectedQuantity", [], "any", false, false, false, 293), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, false, false, 293), "currentQuantity", [], "any", false, false, false, 293))) : (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, false, false, 293), "currentQuantity", [], "any", false, false, false, 293))), "html", null, true);
        yield " ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, true, false, 293), "product", [], "any", false, true, false, 293), "unit", [], "any", true, true, false, 293)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "stockBatch", [], "any", false, false, false, 293), "product", [], "any", false, false, false, 293), "unit", [], "any", false, false, false, 293), "pièce(s)")) : ("pièce(s)")), "html", null, true);
        yield "</span>
                        </div>
                        <div class=\"info-row\">
        ...
        // line 297
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "declaredAmount", [], "any", false, false, false, 297), CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "hmaService", [], "any", false, false, false, 297)), "html", null, true);
        yield "</span>
                        </div>
                        <div class=\"info-row\">
                            ...
                            <span class=\"info-value\">
                                <span class=\"badge 
                                    ";
        // line 303
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "priority", [], "any", false, false, false, 303) == "critical")) {
            yield "bg-danger
                                    ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 304
($context["creditNote"] ?? null), "priority", [], "any", false, false, false, 304) == "high")) {
            yield "bg-warning text-dark
                                    ";
        } elseif ((CoreExtension::getAttribute($this->env, $this->source,         // line 305
($context["creditNote"] ?? null), "priority", [], "any", false, false, false, 305) == "medium")) {
            yield "bg-info
                                    ";
        } else {
            // line 306
        ...
        yield "\">
                                    ";
        // line 307
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::upper($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "priorityLabel", [], "any", false, false, false, 307)), "html", null, true);
        yield "
                                </span>
                            </span>
                        </div>
        ...
        // line 319
        yield Twig\Extension\CoreExtension::nl2br($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "description", [], "any", false, false, false, 319), "html", null, true));
        yield "</p>
                    </div>
                    ...
                    ";
        // line 323
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "attachments", [], "any", false, false, false, 323)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 324
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["creditNote"] ?? null), "attachments", [], "any", false, false, false, 331));
...
";
    ...
    {
        return array (  558 => 371,  550 => 365,  543 => 363,  536 => 359,  530 => 356,  525 => 353,  516 => 349,  510 => 346,  506 => 344,  504 => 343,  493 => 336,  491 => 335,  489 => 334,  486 => 333,  483 => 332,  479 => 331,  470 => 324,  468 => 323,  461 => 319,  446 => 307,  441 => 306,  436 => 305,  432 => 304,  428 => 303,  419 => 297,  410 => 293,  403 => 289,  396 => 285,  382 => 274,  377 => 273,  372 => 272,  368 => 271,  364 => 270,  358 => 268,  353 => 267,  349 => 266,  345 => 265,  337 => 260,  314 => 239,  307 => 238,  72 => 7,  65 => 6,  53 => 4,  42 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "supplier_credit_note/supplier_respond.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\supplier_credit_note\\supplier_respond.html.twig");
    }
}
