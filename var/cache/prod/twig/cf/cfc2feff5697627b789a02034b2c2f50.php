...
class __TwigTemplate_7b4ba587f495bd80dbc3333b13bfe371 extends Template
{
    ...
    <div class=\"row mb-5\">
        ...
        // line 25
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "companyDisplayName", [], "any", false, false, false, 25), "html", null, true);
        yield "
                                </span>
                                <span class=\"text-white-50\">
                                    ...
                                    ";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "fullName", [], "any", false, false, false, 29), "html", null, true);
        yield "
                                </span>
                            </div>
                        </div>
    ...
    ";
        // line 47
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 47), "errors", [], "any", false, false, false, 47)) > 0)) {
            // line 48
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 56), "errors", [], "any", false, false, false, 56));
                                ...
                                <div class=\"col-12 mb-4\">
                                    ...
                                    <div class=\"input-wrapper\">
                                        ...
                                        <input type=\"email\" 
                                               ...
                                               value=\"";
        // line 103
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "email", [], "any", false, false, false, 103), "html", null, true);
        yield "\" 
                                               readonly 
                                               disabled>
                                    </div>
                                ...
                                <div class=\"col-md-6 mb-4\">
                                    ...
                                    <div class=\"input-wrapper\">
                                        ...
                                        ";
        // line 119
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "full_name", [], "any", false, false, false, 119), 'widget', ["attr" => ["class" => ("form-control form-control-lg ps-5" . (((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 121
($context["form"] ?? null), "full_name", [], "any", false, false, false, 121), "vars", [], "any", false, false, false, 121), "errors", [], "any", false, false, false, 121))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" is-invalid") : (""))), "placeholder" => "Votre nom complet"]]);
        // line 124
        yield "
                                    </div>
                                    <div class=\"invalid-feedback d-block\">
                                        ";
        // line 127
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "full_name", [], "any", false, false, false, 127), 'errors');
        yield "
                                    </div>
                                </div>
                                ...
                                <div class=\"col-md-6 mb-4\">
                                    ...
                                    <div class=\"input-wrapper\">
                                        ...
                                        ";
        // line 137
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "phone", [], "any", false, false, false, 137), 'widget', ["attr" => ["class" => ("form-control form-control-lg ps-5" . (((($tmp = Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 139
($context["form"] ?? null), "phone", [], "any", false, false, false, 139), "vars", [], "any", false, false, false, 139), "errors", [], "any", false, false, false, 139))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (" is-invalid") : (""))), "placeholder" => "+212 6XX XX XX XX"]]);
        // line 142
        yield "
                                    </div>
                                    <div class=\"invalid-feedback d-block\">
                                        ";
        // line 145
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "phone", [], "any", false, false, false, 145), 'errors');
        yield "
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=\"text-center\">
                                ...
                                <div class=\"photo-container mb-4\" id=\"photoPreviewContainer\">
                                    <div class=\"position-relative d-inline-block\">
                                        ";
        // line 157
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 157)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 158
            yield "                                            <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/users/" . CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 158))), "html", null, true);
            yield "?";
            ...
            // line 167
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::upper($this->env->getCharset(), Twig\Extension\CoreExtension::first($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "fullName", [], "any", false, false, false, 167))), "html", null, true);
            yield "</span>
                                            </div>
                                        ";
        }
        ...
        yield "                                        
                                        ...
                                        ";
        // line 172
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 172)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 173
        ...
        // line 186
        yield "                                    ";
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "photo", [], "any", false, false, false, 186), 'widget', ["id" => "profile_photo_input", "attr" => ["accept" => "image/jpeg,image/png,image/gif,image/webp", "style" => "display: none;"]]);
        // line 192
        yield "
                                ...
                                ";
        // line 224
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 224)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 225
...
";
        // line 254
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 254)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 255
        ...
        <div class=\"modal-content border-0\">
            ...
            <div class=\"modal-body text-center py-4\">
                <div class=\"mb-4\">
                    <img src=\"";
            // line 267
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/users/" . CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "photo", [], "any", false, false, false, 267))), "html", null, true);
            yield "?";
            ...
            yield "\" 
                         alt=\"";
            // line 268
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["user"] ?? null), "fullName", [], "any", false, false, false, 268), "html", null, true);
            yield "\" 
                         class=\"rounded-circle shadow-lg\"
...
";
        // line 292
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["success"], "method", false, false, false, 292));
...
";
        // line 307
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 307));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 308
            yield "    <div class=\"position-fixed bottom-0 end-0 p-3\" style=\"z-index: 9999\">
...
";
    ...
    {
        return array (  845 => 659,  725 => 542,  718 => 541,  495 => 321,  484 => 316,  474 => 308,  470 => 307,  467 => 306,  456 => 301,  446 => 293,  442 => 292,  438 => 290,  425 => 280,  421 => 279,  407 => 268,  401 => 267,  387 => 255,  385 => 254,  374 => 246,  363 => 238,  354 => 231,  346 => 225,  344 => 224,  310 => 192,  307 => 186,  297 => 177,  291 => 173,  289 => 172,  285 => 170,  279 => 167,  274 => 164,  262 => 158,  260 => 157,  245 => 145,  240 => 142,  238 => 139,  237 => 137,  224 => 127,  219 => 124,  217 => 121,  216 => 119,  197 => 103,  179 => 88,  156 => 67,  146 => 59,  137 => 57,  133 => 56,  123 => 48,  121 => 47,  100 => 29,  93 => 25,  72 => 6,  65 => 5,  53 => 3,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "profile/edit.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\profile\\edit.html.twig");
    }
}
