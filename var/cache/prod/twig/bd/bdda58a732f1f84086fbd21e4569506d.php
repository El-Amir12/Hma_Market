...
class __TwigTemplate_97ae0d6defc147349539291f3674d51f extends Template
{
...
";
    ...
    <div class=\"row g-3 mb-4\">
        ...
        // line 122
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "total_in", [], "any", false, false, false, 122), 0, ",", " "), "html", null, true);
        yield "</div>
                            <div class=\"stat-sub\">";
        // line 123
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "count_in", [], "any", false, false, false, 123), "html", null, true);
                ...
                <div class=\"card-body\">
                    <div class=\"d-flex align-items-center justify-content-between\">
                        <div class=\"flex-grow-1\">
                            ...
                            <div class=\"stat-value\">";
        // line 138
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "total_out", [], "any", false, false, false, 138), 0, ",", " "), "html", null, true);
        yield "</div>
                            <div class=\"stat-sub\">";
        // line 139
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "count_out", [], "any", false, false, false, 139), "html", null, true);
        yield " mouvement(s)</div>
                        </div>
                        <div class=\"stat-icon\">
                ...
                <div class=\"card-body\">
                    <div class=\"d-flex align-items-center justify-content-between\">
                        <div class=\"flex-grow-1\">
                            ...
                            <div class=\"stat-value\">";
        // line 154
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "total_movements", [], "any", false, false, false, 154), 0, ",", " "), "html", null, true);
        yield "</div>
                ...
                <div class=\"card-body\">
                    <div class=\"d-flex align-items-center justify-content-between\">
                        <div class=\"flex-grow-1\">
                            ...
                            <div class=\"stat-value\">";
        // line 170
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["stats"] ?? null), "total_quantity", [], "any", false, false, false, 170), 0, ",", " "), "html", null, true);
        yield "</div>
    ...
    <div class=\"card border-0 shadow-sm mb-4\">
            ...
            <form method=\"get\" class=\"row g-3\">
                <div class=\"col-md-3\">
                    ...
                    <select name=\"type\" class=\"form-select\">
                        ...
                        <option value=\"in\" ";
        // line 195
        yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["filters"] ?? null), "type", [], "any", false, false, false, 195) == "in")) ? ("selected") : (""));
        yield ">Entrées (+) </option>
                        <option value=\"out\" ";
        // line 196
        yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["filters"] ?? null), "type", [], "any", false, false, false, 196) == "out")) ? ("selected") : (""));
        ...
        // line 201
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["filters"] ?? null), "date_from", [], "any", false, false, false, 201), "html", null, true);
        yield "\">
                </div>
                <div class=\"col-md-3\">
        ...
        // line 205
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["filters"] ?? null), "date_to", [], "any", false, false, false, 205), "html", null, true);
        yield "\">
                </div>
    ...
    <div class=\"card border-0 shadow-sm\">
        ...
        // line 223
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["adjustments"] ?? null)), "html", null, true);
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(($context["adjustments"] ?? null));
...
";
    ...
    {
        return array (  502 => 311,  495 => 310,  484 => 302,  472 => 296,  465 => 291,  463 => 290,  453 => 285,  449 => 283,  445 => 281,  437 => 277,  435 => 276,  428 => 272,  420 => 267,  412 => 263,  408 => 262,  402 => 259,  396 => 256,  392 => 255,  385 => 251,  381 => 250,  377 => 249,  371 => 246,  367 => 245,  363 => 243,  358 => 242,  336 => 223,  315 => 205,  308 => 201,  300 => 196,  296 => 195,  268 => 170,  249 => 154,  231 => 139,  227 => 138,  209 => 123,  205 => 122,  188 => 108,  166 => 89,  157 => 82,  150 => 81,  72 => 7,  65 => 6,  54 => 4,  43 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "stock/adjustment/index.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\stock\\adjustment\\index.html.twig");
    }
}
