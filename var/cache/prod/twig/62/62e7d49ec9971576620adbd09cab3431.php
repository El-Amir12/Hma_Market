...
class __TwigTemplate_8c20dca1fab92da4d87f8276afa220a8 extends Template
{
    ...
    <div class=\"row justify-content-center\">
        ...
        // line 80
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["error"], "method", false, false, false, 80));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 81
        ...
        yield "                    
                    ...
                    ";
        // line 96
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["changePasswordForm"] ?? null), 'form_start', ["attr" => ["class" => "needs-validation", "novalidate" => "novalidate", "id" => "change-password-form"]]);
        // line 102
        yield "
                    ...
                    <div class=\"mb-4\">
                        ";
        // line 105
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "oldPassword", [], "any", false, false, false, 105), 'label', ["label_attr" => ["class" => "form-label fw-semibold"], "label" => "Ancien mot de passe"]);
        // line 107
        yield "
                        <div class=\"input-group input-group-lg\">
                            ...
                            ";
        // line 112
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "oldPassword", [], "any", false, false, false, 112), 'widget', ["attr" => ["class" => "form-control border-start-0 ps-0", "placeholder" => "Entrez votre mot de passe actuel", "autocomplete" => "current-password"]]);
        // line 118
        yield "
                        ...
                        ";
        // line 123
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "oldPassword", [], "any", false, false, false, 123), 'errors', ["attr" => ["class" => "text-danger small mt-1"]]);
        yield "
                    </div>
                    ...
                    <div class=\"mb-4\">
                        ";
        // line 127
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "newPassword", [], "any", false, false, false, 127), 'label', ["label_attr" => ["class" => "form-label fw-semibold"], "label" => "Nouveau mot de passe"]);
        // line 129
        yield "
                        <div class=\"input-group input-group-lg\">
                            <span class=\"input-group-text border-end-0 bg-light\">
                            ...
                            ";
        // line 134
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "newPassword", [], "any", false, false, false, 134), 'widget', ["attr" => ["class" => "form-control border-start-0 ps-0", "placeholder" => "8 caractères minimum", "autocomplete" => "new-password"]]);
        // line 140
        yield "
                            <button class=\"btn btn-light border toggle-password\" type=\"button\">
                                <i class=\"fas fa-eye\"></i>
                        ...
                        ";
        // line 145
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "newPassword", [], "any", false, false, false, 145), 'errors', ["attr" => ["class" => "text-danger small mt-1"]]);
        yield "
                    </div>
                    ...
                    <div class=\"mb-4\">
                        ";
        // line 160
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "confirmPassword", [], "any", false, false, false, 160), 'label', ["label_attr" => ["class" => "form-label fw-semibold"], "label" => "Confirmer le mot de passe"]);
        // line 162
        yield "
                        <div class=\"input-group input-group-lg\">
                            <span class=\"input-group-text border-end-0 bg-light\">
                            ...
                            ";
        // line 167
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "confirmPassword", [], "any", false, false, false, 167), 'widget', ["attr" => ["class" => "form-control border-start-0 ps-0", "placeholder" => "Retapez votre nouveau mot de passe", "autocomplete" => "new-password"]]);
        // line 173
        yield "
                            <button class=\"btn btn-light border toggle-password\" type=\"button\">
                                <i class=\"fas fa-eye\"></i>
                        ...
                        ";
        // line 178
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "confirmPassword", [], "any", false, false, false, 178), 'errors', ["attr" => ["class" => "text-danger small mt-1"]]);
        yield "
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const newPasswordInput = document.getElementById('";
        // line 320
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "newPassword", [], "any", false, false, false, 320), "vars", [], "any", false, false, false, 320), "id", [], "any", false, false, false, 320), "html", null, true);
        yield "');
    const confirmPasswordInput = document.getElementById('";
        // line 321
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["changePasswordForm"] ?? null), "confirmPassword", [], "any", false, false, false, 321), "vars", [], "any", false, false, false, 321), "id", [], "any", false, false, false, 321), "html", null, true);
        yield "');
...
";
    ...
    {
        return array (  443 => 321,  439 => 320,  419 => 303,  412 => 302,  340 => 234,  331 => 228,  278 => 178,  271 => 173,  269 => 167,  262 => 162,  260 => 160,  242 => 145,  235 => 140,  233 => 134,  226 => 129,  224 => 127,  217 => 123,  210 => 118,  208 => 112,  201 => 107,  199 => 105,  194 => 102,  192 => 96,  188 => 94,  176 => 88,  167 => 81,  163 => 80,  160 => 79,  148 => 73,  139 => 66,  135 => 65,  97 => 30,  71 => 6,  64 => 5,  53 => 3,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "reset_password/change_password.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\reset_password\\change_password.html.twig");
    }
}
