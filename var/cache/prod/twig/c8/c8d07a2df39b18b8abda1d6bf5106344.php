...
class __TwigTemplate_888b51d392a04a9842b25ba9eefa25a0 extends Template
{
...
<body>
    <div class=\"container\">
        <h1>Commande ";
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["purchase"] ?? null), "purchaseNumber", [], "any", false, false, false, 21), "html", null, true);
        yield "</h1>
        <p>Bonjour ";
        // line 22
        ...
        // line 23
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["purchase"] ?? null), "hmaService", [], "any", false, false, false, 23), "companyName", [], "any", false, false, false, 23), "html", null, true);
        yield ".</p>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["purchase"] ?? null), "purchaseItems", [], "any", false, false, false, 37));
        ...
        // line 49
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, ($context["purchase"] ?? null), "totalAmount", [], "any", false, false, false, 49), 0, ",", " "), "html", null, true);
        yield " FCFA</span></p>

        ";
        // line 51
        if ((($tmp = ($context["customMessage"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 52
            yield "            <p><strong>Message :</strong> ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["customMessage"] ?? null), "html", null, true);
            yield "</p>
        ";
        }
        // line 54
    ...
    {
        return array (  148 => 58,  142 => 55,  139 => 54,  133 => 52,  131 => 51,  126 => 49,  121 => 46,  112 => 43,  108 => 42,  104 => 41,  100 => 40,  96 => 39,  93 => 38,  89 => 37,  72 => 23,  68 => 22,  64 => 21,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "emails/purchase_confirmation.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\emails\\purchase_confirmation.html.twig");
    }
}
