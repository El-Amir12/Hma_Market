...
class __TwigTemplate_15a40eab6841def59a409ce798509e37 extends Template
{
...
<body>
    ";
        ...
        <div class=\"header\">
            ...
            // line 174
            yield (((CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "name", [], "any", true, true, false, 174) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "name", [], "any", false, false, false, 174)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "name", [], "any", false, false, false, 174), "html", null, true)) : ((((CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", true, true, false, 174) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 174)))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 174), "html", null, true)) : ("Votre Entreprise"))));
            yield "</div>
            <div class=\"company-info\">
                ";
            // line 176
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "address", [], "any", false, false, false, 176)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 177
                yield "                    ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "address", [], "any", false, false, false, 177), "html", null, true);
                yield "<br>
                ";
            }
            // line 179
            yield "                ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "phone", [], "any", false, false, false, 179)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 180
                yield "                    Tél: ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "phone", [], "any", false, false, false, 180), "html", null, true);
                yield "<br>
                ";
            }
            // line 182
            yield "                ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 182)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 183
                yield "                    Email: ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 183), "html", null, true);
                yield "
                ";
            }
            // line 185
...
$context["order"], "paymentMethod", [], "any", false, false, false, 261) == "mobile_money")) {
    ...
    {
        return array (  437 => 284,  427 => 280,  418 => 273,  412 => 270,  408 => 268,  406 => 267,  401 => 264,  396 => 262,  391 => 261,  387 => 260,  383 => 259,  371 => 250,  364 => 246,  357 => 242,  347 => 234,  338 => 231,  334 => 230,  330 => 229,  326 => 228,  323 => 227,  319 => 226,  304 => 213,  298 => 210,  294 => 208,  291 => 207,  285 => 204,  281 => 202,  279 => 201,  274 => 199,  267 => 195,  260 => 191,  252 => 185,  246 => 183,  243 => 182,  237 => 180,  234 => 179,  228 => 177,  226 => 176,  221 => 174,  217 => 172,  213 => 171,  42 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "sale/orders/receipts_content.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\sale\\orders\\receipts_content.html.twig");
    }
}
