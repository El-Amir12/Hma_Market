...
class __TwigTemplate_78121114e6164ee856a5088302aac705 extends Template
{
...
<body>
    <div class=\"container\">
        ...
        <div class=\"content\">
            <p>Bonjour <strong>";
        // line 129
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "companyName", [], "any", false, false, false, 129), "html", null, true);
        yield "</strong>,</p>
        ...
        // line 156
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "email", [], "any", false, false, false, 156), "html", null, true);
        yield "</p>
        ...
        // line 182
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["company"] ?? null), "trialEndsAt", [], "any", false, false, false, 182), "d/m/Y"), "html", null, true);
        yield "</p>
    ...
    {
        return array (  291 => 231,  239 => 182,  219 => 165,  209 => 158,  204 => 156,  191 => 146,  171 => 129,  42 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "emails/owner_credentials.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\emails\\owner_credentials.html.twig");
    }
}
