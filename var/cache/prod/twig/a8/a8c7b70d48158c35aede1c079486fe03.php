...
class __TwigTemplate_46a3727ab2b3d06b5f53110f912b2195 extends Template
{
...
";
    ...
    <div class=\"row\">
        ...
        yield "
                    ...
                    ";
        // line 108
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "type", [], "any", false, false, false, 108), 'widget', ["attr" => ["style" => "display: none;", "id" => "typeInput"]]);
        yield "
        ...
        yield "                        </div>
                    ...
                    <div class=\"row g-3 mb-4\">
                        <div class=\"col-md-6\">
                            ";
        // line 148
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 148), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📅 Date de début"]);
        yield "
                            ";
        // line 149
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 149), 'widget', ["attr" => ["class" => "form-control", "id" => "periodStart"]]);
        yield "
                            <small class=\"text-muted\">Maximum 365 jours (1 an)</small>
                            ";
        // line 151
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_start", [], "any", false, false, false, 151), 'errors');
        yield "
                        </div>
                        <div class=\"col-md-6\">
                            ";
        // line 154
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 154), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📅 Date de fin"]);
        yield "
                            ";
        // line 155
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 155), 'widget', ["attr" => ["class" => "form-control", "id" => "periodEnd"]]);
        yield "
                            ";
        // line 156
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "period_end", [], "any", false, false, false, 156), 'errors');
        yield "
                        </div>
                    </div>
                    ...
                    <div class=\"mb-4\">
                        ";
        // line 165
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 165), 'label', ["label_attr" => ["class" => "form-label fw-bold"], "label" => "📝 Notes / Instructions"]);
        yield "
                        ";
        // line 166
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 166), 'widget', ["attr" => ["class" => "form-control", "rows" => 4, "placeholder" => "Informations complémentaires pour l'analyse..."]]);
        yield "
                        <small class=\"text-muted\">Ces notes seront transmises à l'équipe d'analyse</small>
                        ";
        // line 168
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "notes", [], "any", false, false, false, 168), 'errors');
        yield "
                    </div>
...
";
    ...
    {
        return array (  429 => 250,  422 => 249,  379 => 210,  368 => 202,  331 => 168,  326 => 166,  322 => 165,  310 => 156,  306 => 155,  302 => 154,  296 => 151,  291 => 149,  287 => 148,  276 => 139,  270 => 138,  263 => 134,  257 => 131,  251 => 129,  247 => 127,  243 => 125,  241 => 124,  238 => 123,  236 => 122,  233 => 121,  231 => 120,  227 => 119,  223 => 118,  219 => 117,  215 => 115,  212 => 114,  208 => 113,  200 => 108,  194 => 105,  190 => 104,  171 => 88,  151 => 71,  143 => 66,  135 => 60,  128 => 59,  72 => 7,  65 => 6,  54 => 4,  43 => 2,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "company/analysis/new.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\company\\analysis\\new.html.twig");
    }
}
