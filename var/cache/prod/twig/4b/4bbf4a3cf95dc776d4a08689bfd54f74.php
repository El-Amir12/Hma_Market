...
class __TwigTemplate_4e4630be6c8bf491d9bb648ef5a91b4e extends Template
{
    ...
    ";
        ...
        if ((($context["totalPages"] ?? null) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                // line 213
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_promotion_category_index", Twig\Extension\CoreExtension::merge(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 213), "query", [], "any", false, false, false, 213), "all", [], "any", false, false, false, 213), ["page" => $context["page"]])), "html", null, true);
                yield "\">";
...
";
    ...
    {
        return new Source("", "admin/restaurant/promotion/category_recipe/index.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\restaurant\\promotion\\category_recipe\\index.html.twig");
    }
}
