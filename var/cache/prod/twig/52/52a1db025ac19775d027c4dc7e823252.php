...
class __TwigTemplate_8e2bab6b135d9fb989e3b95bd2b6cb0a extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield " - Plat ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 5), "html", null, true);
        yield from [];
    }
    ...
    <div class=\"d-flex flex-wrap justify-content-between align-items-center mb-4\">
        ...
        // line 17
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 17), "html", null, true);
        yield "
            </h1>
        </div>
    ...
    <div class=\"row g-4\">
        ...
        <div class=\"col-lg-6\">
            <div class=\"card shadow-sm border-0 rounded-4 h-100\">
                ...
                <div class=\"card-body p-4\">
                    ";
        // line 134
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "image", [], "any", false, false, false, 134)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 135
            yield "                        <img src=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images_plats/" . CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "image", [], "any", false, false, false, 135))), "html", null, true);
            yield "\" alt=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 135), "html", null, true);
            yield "\" class=\"img-fluid rounded mb-3\" style=\"max-height: 200px; width: 100%; object-fit: cover;\">
                    ";
        } else {
            // line 137
        ...
        yield "                    
                    <div class=\"info-card p-3 bg-light rounded-3 mb-3\">
                        ...
                        <p class=\"fw-bold fs-4 mb-0\">";
        // line 147
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 147), "html", null, true);
        yield "</p>
                    </div>
                    ...
                    <div class=\"info-card p-3 bg-light rounded-3 mb-3\">
                        ...
                        <p class=\"mb-0\">";
        // line 155
        yield Twig\Extension\CoreExtension::nl2br($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "description", [], "any", true, true, false, 155)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "description", [], "any", false, false, false, 155), "Aucune description")) : ("Aucune description")), "html", null, true));
        yield "</p>
                    </div>
        ...
        yield "</p>
                        ...
                        <div class=\"col-6\">
                            <div class=\"info-card p-3 bg-light rounded-3\">
                                ...
                                <p class=\"mb-0\">";
        // line 174
        yield Twig\Extension\CoreExtension::nl2br($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "instructions", [], "any", true, true, false, 174)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "instructions", [], "any", false, false, false, 174), "Aucune instruction")) : ("Aucune instruction")), "html", null, true));
        yield "</p>
                            </div>
                        </div>
                    </div>
        ...
        // line 186
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "sellingPrice", [], "any", false, false, false, 186), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 186), "hmaService", [], "any", false, false, false, 186)), "html", null, true);
        yield "</p>
                            </div>
                        </div>
                        <div class=\"col-6\">
                            <div class=\"info-card p-3 bg-light rounded-3\">
                                ...
                                <p class=\"fw-bold fs-5 mb-0\">
                                    ";
        // line 196
        $context["estimatedMargin"] = $this->extensions['Twig\Extension\CoreExtension']->formatNumber((CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "sellingPrice", [], "any", false, false, false, 196) - (CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "sellingPrice", [], "any", false, false, false, 196) * 0.6)), 0);
        // line 197
        yield "                                    ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['App\Twig\AppExtension']->formatPriceWithCurrency(($context["estimatedMargin"] ?? null), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 197), "hmaService", [], "any", false, false, false, 197)), "html", null, true);
        yield "
                                </p>
                            </div>
                        </div>
                    ...
                    <div class=\"mt-3 pt-3 border-top\">
                        <div class=\"d-flex align-items-center\">
                            <div class=\"flex-shrink-0\">
                                <span class=\"badge ";
        // line 206
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "isActive", [], "any", false, false, false, 206)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("bg-success") : ("bg-secondary"));
        yield " fs-6 px-3 py-2\">
                                    <i class=\"fas ";
        // line 207
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "isActive", [], "any", false, false, false, 207)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("fa-check-circle") : ("fa-ban"));
        yield " me-1\"></i>
                                    ";
        // line 208
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "isActive", [], "any", false, false, false, 208)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("ACTIF") : ("INACTIF"));
        yield "
                                </span>
                            </div>
                            <div class=\"flex-grow-1 ms-3\">
        ...
        // line 213
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "user", [], "any", false, false, false, 213), "fullName", [], "any", false, false, false, 213), "html", null, true);
        yield "</p>
                                <small class=\"text-muted\">";
        // line 214
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "user", [], "any", false, false, false, 214), "email", [], "any", false, false, false, 214), "html", null, true);
        yield "</small>
                            </div>
                        </div>
                    </div>
    ...
    <div class=\"card shadow-sm border-0 rounded-4 mt-4 bg-info bg-opacity-10\">
        ...
        // line 236
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 236), "html", null, true);
        yield "</strong>.
                    </p>
                </div>
            </div>
    ...
    <div class=\"modal fade\" id=\"deleteModal\" tabindex=\"-1\">
        ...
        // line 256
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["promotion"] ?? null), "name", [], "any", false, false, false, 256), "html", null, true);
        yield "</strong> ne sera plus appliquée au plat <strong>";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["recipe"] ?? null), "name", [], "any", false, false, false, 256), "html", null, true);
        yield "</strong>.</p>
                </div>
        ...
        // line 260
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_restaurant_promotion_recipe_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, ($context["promotionRecipe"] ?? null), "id", [], "any", false, false, false, 260)]), "html", null, true);
        yield "\">
                        <input type=\"hidden\" name=\"_token\" value=\"";
        // line 261
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete-recipe" . CoreExtension::getAttribute($this->env, $this->source, ($context["promotionRecipe"] ?? null), "id", [], "any", false, false, false, 261))), "html", null, true);
        yield "\">
...
";
    ...
    {
        return array (  456 => 261,  452 => 260,  443 => 256,  420 => 236,  395 => 214,  391 => 213,  383 => 208,  379 => 207,  375 => 206,  362 => 197,  360 => 196,  347 => 186,  332 => 174,  320 => 165,  307 => 155,  296 => 147,  288 => 141,  282 => 137,  274 => 135,  272 => 134,  254 => 118,  248 => 116,  246 => 115,  242 => 114,  235 => 110,  231 => 109,  227 => 108,  217 => 100,  213 => 98,  207 => 96,  205 => 95,  192 => 85,  179 => 75,  169 => 67,  163 => 65,  157 => 63,  155 => 62,  143 => 53,  135 => 47,  129 => 43,  121 => 41,  119 => 40,  97 => 21,  90 => 17,  85 => 15,  78 => 11,  73 => 8,  66 => 7,  52 => 5,  41 => 3,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "admin/restaurant/promotion/recipe/show.html.twig", "C:\\wamp64\\www\\Mes projets en Symfony\\hma_market\\templates\\admin\\restaurant\\promotion\\recipe\\show.html.twig");
    }
}
