 ...
 */
final class Version20260129143105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase_item CHANGE expiry_date expiry_date DATE DEFAULT NULL, CHANGE manufacturing_date manufacturing_date DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stock_movement ADD reference_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase_item CHANGE expiry_date expiry_date DATE NOT NULL, CHANGE manufacturing_date manufacturing_date DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE stock_movement DROP reference_id');
    }
}
