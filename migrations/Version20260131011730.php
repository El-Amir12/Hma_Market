 ...
 */
final class Version20260131011730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase_item DROP stock_batch_id');
        ...
        $this->addSql('ALTER TABLE stock_batch DROP INDEX IDX_641B4E259B59827, ADD UNIQUE INDEX UNIQ_641B4E259B59827 (purchase_item_id)');
        $this->addSql('ALTER TABLE stock_batch CHANGE purchase_item_id purchase_item_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE stock_movement CHANGE reference_id reference_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase_item ADD stock_batch_id INT NOT NULL');
        $this->addSql('ALTER TABLE reset_password_request DROP FOREIGN KEY FK_7CE748AA76ED395');
        $this->addSql('ALTER TABLE stock_batch DROP INDEX UNIQ_641B4E259B59827, ADD INDEX IDX_641B4E259B59827 (purchase_item_id)');
        ...
        $this->addSql('ALTER TABLE stock_batch CHANGE purchase_item_id purchase_item_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE stock_movement CHANGE reference_id reference_id INT NOT NULL');
    }
}
